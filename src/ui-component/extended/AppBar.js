                ...
                <Container>
                    <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
                        ...
                        <Stack direction="row" sx={{ display: { xs: 'none', sm: 'block' } }} spacing={{ xs: 1.5, md: 2.5 }}>
                            ...
                            <Button color="inherit" component={Link} href="https://meeroket.gitbook.io/" target="_blank">
                                Documentation
                            </Button>
                            <Button
                                component={Link}
                                ...
                                {drawerToggle && (
                                    ...
                                    >
                                        <List>
                                            ...
                                            <Link style={{ textDecoration: 'none' }} href="https://meeroket.gitbook.io/" target="_blank">
                                                <ListItemButton component="a">
                                                    <ListItemIcon>
                                                        <IconBook />
                                                    </ListItemIcon>
