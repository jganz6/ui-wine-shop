...
const Palette = (navType, presetColor) => {
    ...
    return createTheme({
        palette: {
            ...
            tertiary: {
                light: navType === 'dark' ? colors.darkTertiaryLight : colors.tertiaryLight,
                main: navType === 'dark' ? colors.darkTertiaryMain : colors.tertiaryMain,
                dark: navType === 'dark' ? colors.darkTertiaryDark : colors.tertiaryDark,
                200: navType === 'dark' ? colors.darkTertiary200 : colors.tertiary200,
                800: navType === 'dark' ? colors.darkTertiary800 : colors.tertiary800
            },
            error: {
