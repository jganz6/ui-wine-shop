...
import imageGreen from 'assets/images/maintenance/img-error-green.svg';
...
const CardMediaGreen = styled('img')({
    position: 'absolute',
    top: 0,
    left: 0,
    width: '100%',
                ...
                <Grid container justifyContent="center" spacing={gridSpacing}>
                    <Grid item xs={12}>
                        <CardMediaWrapper>
                            ...
                            <CardMediaGreen src={imageGreen} title="Slider 2 image" />
                    ...
                    <Grid item xs={12}>
                        <ErrorWrapper>
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item xs={12}>
                                    <AnimateButton>
                                        <Button variant="contained" size="large" component={Link} to={BASE_PATH}>
