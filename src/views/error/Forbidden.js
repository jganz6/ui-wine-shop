...
// project imports
import { BASE_PATH, DASHBOARD_PATH_ADMIN, DASHBOARD_PATH_WAREHOUSE, DASHBOARD_PATH_AGENT } from 'config';
            ...
            <div className="App">
                ...
                <div>
                    <div className="margin-bottom-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="240" viewBox="0 0 586.47858 659.29778">
                    ...
                    <p className="heading-primary margin-bottom-md">We are Sorry..</p>
                    <p className="subheading">
                        The page you're trying to access has restricted access. Please refer to your system administrator
                    </p>
                    {!['29', '10', '20'].includes(user?.role) ? (
                        <Button variant="contained" onClick={handleLogout} startIcon={<IconLogout />}>
                            Logout
                        </Button>
                    ) : (
                        <Button
                            ...
                            to={
                                user?.role === '29'
                                    ? DASHBOARD_PATH_ADMIN
                                    : user?.role === '10'
                                    ? DASHBOARD_PATH_WAREHOUSE
                                    : user?.role === '20'
                                    ? DASHBOARD_PATH_AGENT
                                    : BASE_PATH
                            }
                            startIcon={<HomeIcon />}
                        >
