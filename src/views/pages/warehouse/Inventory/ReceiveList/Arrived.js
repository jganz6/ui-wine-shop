                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">{row.receive_qty}</TableCell>
                                        ...
                                        <TableCell align="center">
                                            <Button
                                                ...
                                                onClick={() =>
                                                    user?.role === '29'
                                                        ? navigate('/admin/warehouse/receive-list/arrived/detail', { state: row })
                                                        : navigate('/warehouse/inventory/receive-list/arrived/detail', { state: row })
                                                }
                                            >
                                                Detail
                                            </Button>
